...
const FeedbackThree = ({
  ...
  spacing?: string;
  bottom_slider?: boolean;
}) => {
  return (
    <>
      <div
        className={`feedback-section-three position-relative ${spacing ? spacing : "pt-180 lg-pt-100"}`}
      >
        <div className="container">
          <div className="position-relative">
            <div className="row">
              <div className="col-lg-6">
                ...
                <div className="slider-wrapper position-relative">
                  <Image
                    src={icon}
                    alt="icon"
                    className="lazy-img shapes icon"
                  />
              ...
              <div className="col-xl-6 col-lg-5 ms-auto text-center text-lg-end">
                <div className="media-wrapper d-inline-block position-relative md-mt-40">
                  <img
                    src="/assets/images/media/img_21.jpg"
                    alt="media_img"
                    className="lazy-img"
                    style={imgStyle}
                  />
            ...
            {bottom_slider && (
              <div className="partner-logo-one pt-150 md-pt-80">
                <p className="fw-500 text-dark text-lg mb-40 sm-mb-30">
                  <span className="text-decoration-underline fs-3">
                    150,000+
                  </span>
