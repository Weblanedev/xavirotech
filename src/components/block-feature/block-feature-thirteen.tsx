            ...
            <div className="col-lg-6 order-lg-last">
              <div className="ps-xl-5">
                <div className="d-flex align-items-center">
                  <img
                    src="/assets/images/assets/trustpilot.png"
                    alt="trustpilot"
                    className="lazy-img icon"
                  />
                  <span className="ps-4">
                    (<span className="fw-500 text-dark">4.7</span> Rating)
                  </span>
                </div>
                <div className="title-two pe-xxl-4 mt-20 mb-75 md-mb-50">
                  <h2 className="text-dark">
                    Leading insurer on a global scale.
                  </h2>
                </div>
                <a href="about-us-v1.html" className="btn-twenty">
                  Learn More
                </a>
              </div>
            </div>
                ...
                <div className="row align-items-end">
                  <div className="col-md-6 order-md-last">
                    <div className="pe-xxl-5 pe-xl-4 line-loop position-relative z-1">
                      <div className="main-count fw-500 color-deep mb-20">
                        <span className="counter">83</span>%
                      </div>
                      <p className="m0">
                        We’ve hit the billion by initiate the insurance in time
                        to our customer in 2024
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      <div className="d-inline-flex align-items-end p0 position-relative z-1 sm-mt-40">
                        <div className="chart-box text-center color-deep wow fadeInUp">
                          <span className="d-block mb-10">₦2.79tr</span>
                          <div
                        ...
                        <div
                          className="chart-box text-center color-deep wow fadeInUp"
                          data-wow-delay="0.1s"
                        >
                          <span className="d-block mb-10">₦14.4b</span>
                          <div
                            className="chart-inner"
                            style={{ height: 250 + "px" }}
                          ></div>
